...
b. TEAM NAME FOLDER: Create a top level folder with name AppathonTeam_AAA. You will get number AAA from the Appathon registration Team.
This number is unique and will be used to identify the Teams from the code/artifacts. Please make sure this number is reflected correctly.
